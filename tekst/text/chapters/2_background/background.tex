...
A literature study has been conducted to situate the thesis topic. Multiple subjects lay at the base of the design described in section \ref{design}. First, the switch to, the components, and types of electronic health record systems are described. Next three key subjects are explained in the following order: chronic diseases, telemonitoring, and dashboard design. The last section mentions the issues surrounding medical data privacy and standards. 
    ...
    Although out of the scope of this thesis, data privacy and the use of health standards are important components of health software and are important to mention. From the onset of the design phase, data security and standard choices need to be kept in mind. When purchasing a commercial system, these aspects should not be forgotten.
        ...
        Striking a balance between free access to information and protection of privacy and confidentiality is difficult. Should too much information be widely available, the chance that the data is inappropriately used increases. Also, if not enough information is accessible, areas such as clinical research are hindered. Data pooling becomes less viable, preventing the analysis of disease incidence and intervention.
