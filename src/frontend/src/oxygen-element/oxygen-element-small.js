 ...
 * @polymer
 */
class OxygenElementSmall extends PolymerElement {
    static get template() {
        return html`
    ...
    resize(e) {
        this.dispatchEvent(new CustomEvent('resize', { composed: true, detail: { resizeTo: "oxygen-element" } }));
    }
...
window.customElements.define('oxygen-element-small', OxygenElementSmall);
